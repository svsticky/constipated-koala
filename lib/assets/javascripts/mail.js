$(document).on( 'ready page:load', function(){  
  $( 'form#mail #recipients' ).find( 'select' ).on( 'change', function(){
  ...
  $( 'form#mail' ).on( 'recipient_added recipient_payed recipient_unpayed', function( event, name, email ){
    alert('[MAIL] ' + email + ' added' )
  });
  
  $( 'form#mail' ).on( 'recipient_removed', function( event, name, email ){
    alert('[MAIL] ' + email + ' removed' )
  });
