    ...
    return this.each(function(){
      ...
      $(this).on( 'focusout', function(){
        ...
        if( $(this).next(opts.dropdown).find( 'li.active' ).length == 1 ){
          $(this).trigger( 'selected', $.fn.search.retrieve( $(this).next(opts.dropdown).find( 'li.active' ).find( 'a' )) );
        
          $( 'ul.dropdown-menu' ).delay(5).hide(1);
       ...
       if( event.keyCode == 13){
          ...
          $.ajax({
            ...
            $(dropdown).find( 'li a' ).on( 'click', function(){
              ...
              $( 'ul.dropdown-menu' ).delay(5).hide(1).empty();
            });
