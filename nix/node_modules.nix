...
let
  sources = {
    ...
    "electron-to-chromium-1.4.104" = {
      ...
      version = "1.4.104";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.104.tgz";
        sha512 = "2kjoAyiG7uMyGRM9mx25s3HAzmQG2ayuYXxsFmYugHSDcwxREgLtscZvbL1JcW9S/OemeQ3f/SG6JhDwpnCclQ==";
      };
    };
    "emojis-list-3.0.0" = {
      name = "emojis-list";
    ...
    "flatpickr-4.6.11" = {
      ...
      version = "4.6.11";
      src = fetchurl {
        url = "https://registry.npmjs.org/flatpickr/-/flatpickr-4.6.11.tgz";
        sha512 = "/rnbE/hu5I5zndLEyYfYvqE4vPDvI5At0lFcQA5eOPfjquZLcQ0HMKTL7rv5/+DvbPM3/vJcXpXjB/DjBh+1jw==";
      };
    };
    "flatten-1.0.3" = {
      name = "flatten";
    ...
    "webpack-assets-manifest-5.1.0" = {
      ...
      version = "5.1.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/webpack-assets-manifest/-/webpack-assets-manifest-5.1.0.tgz";
        sha512 = "kPuTMEjBrqZQVJ5M6yXNBCEdFbQQn7p+loNXt8NOeDFaAbsNFWqqwR0YL1mfG5LbwhK5FLXWXpuK3GuIIZ46rg==";
      };
    };
    "webpack-cli-4.9.2" = {
      name = "webpack-cli";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.104"
      ...
      (sources."webpack-assets-manifest-5.1.0" // {
        dependencies = [
          sources."ansi-styles-4.3.0"
          sources."chalk-4.1.2"
          sources."color-convert-2.0.1"
