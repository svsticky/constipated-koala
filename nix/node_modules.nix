...
let
  sources = {
    ...
    "@rails/webpacker-5.2.1" = {
      ...
      version = "5.2.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@rails/webpacker/-/webpacker-5.2.1.tgz";
        sha512 = "rO0kOv0o4ESB8ZnKX+b54ZKogNJGWSMULGmsJacREfm9SahKEQwXBeHNsqSGtS9NAPsU6YUFhGKRd4i/kbMNrQ==";
      };
    };
    ...
    "electron-to-chromium-1.3.700" = {
      ...
      version = "1.3.700";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.3.700.tgz";
        sha512 = "wQtaxVZzpOeCjW1CGuC5W3bYjE2jglvk076LcTautBOB9UtHztty7wNzjVsndiMcSsdUsdMy5w76w5J1U7OPTQ==";
      };
    };
    "elliptic-6.5.4" = {
      name = "elliptic";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.3.700"
