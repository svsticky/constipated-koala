...
let
  sources = {
    ...
    "@rails/webpacker-5.4.3" = {
      ...
      version = "5.4.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/@rails/webpacker/-/webpacker-5.4.3.tgz";
        sha512 = "tEM8tpUtfx6FxKwcuQ9+v6pzgqM5LeAdhT6IJ4Te3BPKFO1xrGrXugqeRuZ+gE8ASDZRTOK6yuQkapOpuX5JdA==";
      };
    };
    "@types/glob-7.2.0" = {
