...
let
  sources = {
    ...
    "tailwindcss-3.0.16" = {
      ...
      version = "3.0.16";
      src = fetchurl {
        url = "https://registry.npmjs.org/tailwindcss/-/tailwindcss-3.0.16.tgz";
        sha512 = "1L8E5Wr+o1c4kxxObNz2owJe94a7BLEMV+2Lz6wzprJdcs3ENSRR9t4OZf2OqtRNS/q/zFPuOKoLtQoy3Lrhhw==";
      };
    };
    "tapable-2.2.1" = {
      name = "tapable";
