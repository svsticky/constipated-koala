...
let
  sources = {
    ...
    "browserslist-4.17.6" = {
      ...
      version = "4.17.6";
      src = fetchurl {
        url = "https://registry.npmjs.org/browserslist/-/browserslist-4.17.6.tgz";
    ...
    "css-minimizer-webpack-plugin-3.1.3" = {
      ...
      version = "3.1.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/css-minimizer-webpack-plugin/-/css-minimizer-webpack-plugin-3.1.3.tgz";
        sha512 = "x+6kzXprepysouo513zKibWCbWTGIvH9OrEsMRRV8EcJ7vYY/zRg0lR8tCzMHMap+lhNPOrYCdDagjRmfnGGxw==";
      };
    };
    ...
    "cssnano-5.0.10" = {
      ...
      version = "5.0.10";
      src = fetchurl {
        url = "https://registry.npmjs.org/cssnano/-/cssnano-5.0.10.tgz";
    ...
    "cssnano-preset-default-5.1.6" = {
      ...
      version = "5.1.6";
      src = fetchurl {
        url = "https://registry.npmjs.org/cssnano-preset-default/-/cssnano-preset-default-5.1.6.tgz";
    ...
    "postcss-merge-longhand-5.0.3" = {
      ...
      version = "5.0.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/postcss-merge-longhand/-/postcss-merge-longhand-5.0.3.tgz";
    ...
    "webpack-5.63.0" = {
      ...
      src = fetchurl {
        ...
        sha512 = "HYrw6bkj/MDmphAXvqLEvn2fVoDZsYu6O638WjK6lSNgIpjb5jl/KtOrqJyU9EC/ZV9mLUmZW5h4mASB+CVA4A==";
      };
    };
  ...
  args = {
    ...
    dependencies = [
      ...
      (sources."compression-webpack-plugin-9.0.0" // {
        dependencies = [
      ...
      (sources."css-minimizer-webpack-plugin-3.1.3" // {
        dependencies = [
          sources."schema-utils-3.1.1"
          sources."source-map-0.6.1"
        ];
      ...
      sources."cssnano-5.0.10"
      sources."cssnano-preset-default-5.1.6"
      ...
      sources."postcss-merge-longhand-5.0.3"
