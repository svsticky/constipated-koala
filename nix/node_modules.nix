...
let
  sources = {
    ...
    "@rails/ujs-6.0.3" = {
      ...
      version = "6.0.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/@rails/ujs/-/ujs-6.0.3.tgz";
        sha512 = "CM9OEvoN9eXkaX7PXEnbsQLULJ97b9rVmwliZbz/iBOERLJ68Rk3ClJe+fQEMKU4CBZfky2lIRnfslOdUs9SLQ==";
      };
    };
    "@rails/webpacker-5.2.2" = {
      ...
      version = "5.2.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/@rails/webpacker/-/webpacker-5.2.2.tgz";
        sha512 = "ZRzS8mm4rYlpjZrAvj5bKJ9KAEadcHQTDNSBxKaQPeYCiG8X4LmSJvNNkg4AZRPSmBC5P83kn5pgD9dC2XdhUA==";
      };
    };
    "@tailwindcss/postcss7-compat-2.1.2" = {
      name = "_at_tailwindcss_slash_postcss7-compat";
      packageName = "@tailwindcss/postcss7-compat";
      version = "2.1.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/@tailwindcss/postcss7-compat/-/postcss7-compat-2.1.2.tgz";
        sha512 = "bH2kw6uyqLnDMP8wzDUsis5ovrsRzfHEyiL1McADvqlW54g6y0KVHX1xzO7PH8Fl5s0Sq8vDOAp4+3V8MEcZ9g==";
      };
    };
    "@types/glob-7.1.3" = {
    ...
    "jquery-ujs-1.2.2" = {
      ...
      version = "1.2.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/jquery-ujs/-/jquery-ujs-1.2.2.tgz";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."@rails/ujs-6.0.3"
      sources."@rails/webpacker-5.2.2"
      (sources."@tailwindcss/postcss7-compat-2.1.2" // {
        dependencies = [
